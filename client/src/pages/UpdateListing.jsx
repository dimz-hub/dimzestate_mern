    ...
    <main className='p-3 max-w-4xl mx-auto'>
     ...
     <form onSubmit={handleSubmit} className='flex flex-col '>
        <div className='flex flex-col gap-4 flex-1'>
            <input type='text' placeholder='Name' className='border p-3 bounded-lg'
        ...
        <div>
           <button disabled = {loading} className='p-3 mt-[20px] bg-slate-700 text-white rounded-lg uppercase
